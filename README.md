...
| 14  | Simple CI pipeline with Github Action          | [simple-ci-pipeline-github-actions](./projects/simple-ci-pipeline-github-actions/)                    | `CI/CD` `GitHub Actions` `Python`                      | ✔️ Done     |
...
| 17  | Configuration Management with Ansible          | [ansible-configuration-management](./projects/ansible-configuration-management/)                     | `Ansible` `Configuration Management`                   | ✔️ Done     |
