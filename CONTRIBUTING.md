...
1. [Fork the repository](https://github.com/tungbq/devops-project).
...
7. Next, rinse and repeat the following:
    ...
    3. Create a PR on the devops-project repository. There should be a PR template to help you do so.
